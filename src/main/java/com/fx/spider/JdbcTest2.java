...
public class JdbcTest2 { //定义一个类
    ...
    public JdbcTest2(String phone, String password) {
    ...
    public static void main(String[] args) throws Exception { //主方法
        try {
            ...
            String querySql = "select phone, password from fx_order_account where id > 3607 ORDER BY id";          //5.你想要查找的表名。
                ...
                new Thread(new Runnable() {
                    ...
                    public void run() {
                        try {
                            ...
                            JdbcTest2 jdbcTest = new JdbcTest2(account.getPhone(), account.getPassword());
...
//                                            .data("maddr[is_default]", "true")
                                            ...
                                            .data("maddr[addr]", "刘生 13670823097 广东省深圳市南山区东滨路4096号鸿丰酒店春满园")
                                            .data("maddr[is_default]", "true")
                               .execute();
